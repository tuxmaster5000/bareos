...
pkg_check_modules("ZFS" "libzfs" IMPORTED_TARGET GLOBAL)
find_package(Boost 1.32)
if(${ZFS_FOUND} AND ${Boost_FOUND})
  set(HAVE_SYS_ZFS_H 1)
  set(ZFS_LIBRARIES ${ZFS_LIBRARY_DIRS})
endif()
if(${ZFS_FOUND} AND NOT ${Boost_FOUND})
  message(WARNING "ZFS requies Boost >= 1.32")
endif()
